...
interface ICpluseditionRequestHandler {
    fun handleRequest(request: ICpluseditionRequest, response: ICpluseditionResponse, cleanrpath: String): Boolean
    fun <R> recentsAction(callback: Fun11<IRecentsHandler, R>): R
    fun <R> filepickerAction(callback: Fun11<IFilepickerHandler, R>): R
}