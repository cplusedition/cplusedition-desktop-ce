...
/**
 * Write binary data in big endian order to a byte array.
 */
class BEByteArrayBinaryWriter : AbstractByteArrayBinaryWriter {

    constructor(charset: Charset = TextUtil.UTF8()) : super(charset) {}
    constructor(a: ByteArray, charset: Charset = TextUtil.UTF8()) : super(a, charset) {}
