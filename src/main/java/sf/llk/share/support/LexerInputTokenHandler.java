...
/**
 * A token handler that create custom token with minimal size and use lexer input for source text.
 */
public class LexerInputTokenHandler extends AbstractTokenHandler {

    protected ILLKLexerInput lexerInput;

    public LexerInputTokenHandler(final ILLKLexerInput input, final int[] specialtokens) {
        super(specialtokens);
        lexerInput = input;
    }

    public LexerInputTokenHandler(final ILLKLexerInput input, final INamePool namepool, final int[] specialtokens) {
    ...
    public ILLKToken createToken(final int type, final int start, final int end) {
        return new CustomToken(type, start, end, lexerInput);
    }

    @Override
    public ILLKToken createToken(final int type, final int start, final int end, final Object data) {
        return new CustomDataToken(type, start, end, lexerInput, data);
    }
    ...
    public ILLKToken createSpecialToken(final int type, final int start, final int end) {
        return new CustomSpecialToken(type, start, end, lexerInput);
    }

    @Override
    public ILLKToken createSpecialToken(final int type, final int start, final int end, final Object data) {
        return new CustomSpecialDataToken(type, start, end, lexerInput, data);
    }
    ...
    public static class CustomSpecialToken extends AbstractToken implements CharSequence {
        ...
        protected final ILLKLexerInput input;

        public CustomSpecialToken(final int type, final int start, final int end, final ILLKLexerInput input) {
        ...
        public CharSequence subSequence(final int start, final int end) {
            return new CharSequenceRange(this, start, end);
        }
    ...
    public static class CustomSpecialDataToken extends CustomSpecialToken {
        ...
        public CustomSpecialDataToken(
            final int type, final int start, final int end, final ILLKLexerInput input, final Object data) {
            super(type, start, end, input);
            this.data = data;
        }
    ...
    public static class CustomToken extends AbstractToken implements CharSequence {
        ...
        public CustomToken(final int type, final int start, final int end, final ILLKLexerInput input) {
            super(type, start, end);
            this.input = input;
        }
