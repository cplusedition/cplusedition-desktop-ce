 ...
 */
public class FloatAttrFactory extends AbstractAttrFactory {
    ...
    public static FloatAttrFactory getDefault() {
        if (instance == null) {
    ...
    public static float create(String stringvalue) {
        if (instance == null) {
            instance = new FloatAttrFactory();
        }
        return ((float) instance.createObject(stringvalue, null));
    }
