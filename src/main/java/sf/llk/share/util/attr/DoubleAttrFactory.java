 ...
 */
public class DoubleAttrFactory extends AbstractAttrFactory {
    ...
    public static DoubleAttrFactory getDefault() {
        if (instance == null) {
    ...
    public static double create(String stringvalue) {
        if (instance == null) {
            instance = new DoubleAttrFactory();
        }
        return ((double) instance.createObject(stringvalue, null));
    }
