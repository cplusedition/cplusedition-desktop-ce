 ...
 */
public class StringAttrFactory extends AbstractAttrFactory {
    ...
    public static StringAttrFactory getDefault() {
        if (instance == null) {
    ...
    public static String create(String stringvalue) {
        if (instance == null) {
            instance = new StringAttrFactory();
        }
        return (String) instance.createObject(stringvalue, null);
    }
