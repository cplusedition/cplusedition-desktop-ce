 ...
 */
public class LongAttrFactory extends AbstractAttrFactory {
    ...
    public static LongAttrFactory getDefault() {
        if (instance == null) {
    ...
    public static long create(String stringvalue) {
        if (instance == null) {
            instance = new LongAttrFactory();
        }
        return ((Long) instance.createObject(stringvalue, null));
    }
